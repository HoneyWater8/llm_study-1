...
if prompt is not None:
    ...
    # AI 응답을 세션 상태에 추가
    # AI 응답 표시
    assistant_message = print_message(ROLE_TYPE.assistant.name, get_response_from_llm(
            llm=get_llm(), messages=st.session_state.messages, llm_name=choiced_llm), is_streaming=True)
